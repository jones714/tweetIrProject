...
repository = {'china': 'chinaData.json', 'wuhan': 'wuhanData.json', 'covid': 'covidData.json', 'coronavirus': 'coronavirusData.json', 'sarscov': 'sarsCovData.json'}
...
for keyword in keywords:
	...
	data[keyword] = {}
	data[keyword]['content'], data[keyword]['likes'], data[keyword]['retweets'], data[keyword]['vocab'] = preprocessData(repository[keyword])
